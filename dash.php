  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==6) echo'class="active"'; ?>><a href="headdash.php?q=6">Update Info</a></li> <!-- Add this line --> 
      </ul>
          </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
...
if(@$_GET['q']== 1) 
{
  $q=mysqli_query($con,"SELECT DISTINCT q.title, u.name, u.college, h.score, h.date, q.eid FROM user u, history h, quiz q WHERE q.email='$email' AND q.eid=h.eid AND h.email=u.email ORDER BY q.eid DESC") or die('Error197');
...
if(@$_GET['q']== 2) 
{
  $q = mysqli_query($con, "SELECT * FROM `rank` ORDER BY score DESC") or die('Error at line 162: ' . mysqli_error($con));
...
<div class="panel panel-default">
    <div class="panel-heading">Update Admin Information</div>
    <div class="panel-body">
        <form method="post" action="update.php" class="form-horizontal">
            <div class="form-group">
                <label class="col-md-4 control-label" for="current_email">Current Email</label>
                <div class="col-md-6">
                    <input id="current_email" name="current_email" type="email" class="form-control input-md" value="<?php echo $email; ?>" readonly>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label" for="new_role">New Role</label>
                <div class="col-md-6">
                    <select id="new_role" name="new_role" class="form-control">
